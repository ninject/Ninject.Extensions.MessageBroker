...
namespace Ninject.Extensions.MessageBroker.Model.Subscriptions
{
    ...
    /// </summary>
    public interface IMessageSubscriptionFactory : INinjectComponent
    {
        /// <summary>
        ...
        IMessageSubscription Create( IMessageChannel channel, object subscriber, MethodInjector injector,
